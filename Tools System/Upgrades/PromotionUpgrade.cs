...
public class PromotionUpgrade : ToolUpgrade
{
    public PromotionUpgrade(int level, Entity player, Tool connectedTool) : base("Promotion", level, player, connectedTool)
    {
    }
    ...
    {
        return FormatDescription("Increases effectiveness of Hardworker by <TOOL_VALUE>%");
    }
    ...
    {
        return new PromotionUpgrade(Level, _entity, _connectedTool);
    }
}
