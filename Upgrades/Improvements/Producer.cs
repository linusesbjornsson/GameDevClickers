...
public class Producer : ToolUpgrade
{
    public Producer(int level, Entity player, Tool connectedTool) : base("Producer", level, player, connectedTool)
    {
    }
    ...
    {
        return FormatDescription("Adds <TOOL_VALUE>% of your total Audio to the progress of all active jobs");
    }
    ...
    {
        Producer tool = new Producer(Level, _entity, _connectedTool);
        return tool;
    }

    public override ToolID GetID()
    {
        return ToolID.PRODUCER;
    }
}